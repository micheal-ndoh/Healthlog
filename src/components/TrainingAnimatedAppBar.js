...
const TrainingAnimatedAppBar = ({ scrollY }) => {
  ...
  return (
    ...
    >
      <View style={styles.contentContainer}>
        <Animated.Text style={[styles.title, { fontSize: titleFontSize }]}>Training</Animated.Text>
...
export default TrainingAnimatedAppBar;
